...
def main():
    ...
    if st.sidebar.button("🏪 Punto de Venta", use_container_width=True):
        st.session_state.pagina_seleccionada = "Punto de Venta"
    ...
    if st.sidebar.button("🛒 Pedidos y Reabastecimiento", use_container_width=True):
        st.session_state.pagina_seleccionada = "Pedidos y Reabastecimiento"
    
    if st.sidebar.button("💰 Finanzas", use_container_width=True):
        st.session_state.pagina_seleccionada = "Finanzas"
    
    if st.sidebar.button("👥 Turnos y Atención al Cliente", use_container_width=True):
    ...
    if st.session_state.rol_usuario == "admin":
        if st.sidebar.button("🔐 Gestión de Usuarios", use_container_width=True):
