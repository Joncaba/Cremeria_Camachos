-- Script SOLO para insertar datos (sin RLS que bloquee)
-- Ejecutar DESPUÉS de haber creado las tablas

-- IMPORTANTE: Desactivar RLS temporalmente para insertar datos
...
BEGIN
    ...
    RAISE NOTICE '📊 Recuerda: RLS está DESACTIVADO para permitir operaciones sin autenticación';
    RAISE NOTICE '💡 Si necesitas seguridad, activa RLS después de confirmar que todo funciona';
END $$;
